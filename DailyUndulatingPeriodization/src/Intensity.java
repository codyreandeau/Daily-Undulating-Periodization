...
public class Intensity extends JFrame {
	...
	//Declare variables and create instantce of the power class
	private JPanel contentPane;
	Power showPower = new Power();
	//These three variables are for the decision statements in the Template Jframe
	...
	public Intensity() {
		...
		btnSquat.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//Close this Jframe and Show the Power window
				squatClick++;
				dispose();
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			//If the user wants, they can go back to DUPGUI
			dispose();
